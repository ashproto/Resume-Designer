...
| Security candidate | **0.1.5** adds durable, idempotent application retries and requires the matching desktop capability. Local validation passed: **454 extension tests/14 files**, **2,135 desktop tests/131 files**, and **90 release-automation tests**; lint, production builds, strict Store packaging and ZIP integrity passed. Desktop lint retains two prior unrelated warnings. ZIP: **680,749 bytes**, **12 files**, SHA-256 `562e464f85dfcc01ac4c55f09810fcd91f0e8f230569ba31a90f1ee1e2d2f4e5`. Both full dependency audits are clear. Fresh CI and bot review remain gates. |
